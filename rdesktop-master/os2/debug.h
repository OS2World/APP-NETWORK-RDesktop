...
#define debugDone() do { } while( 0 )
#define debug(s,...) do { } while( 0 )
#define debugText(s,...) do { } while( 0 )
#define debugTextBuf(buf,buflen,crlf_fl)
#define debugBufPSZ(buf, buflen)
#define debugPCP(s) do { } while( 0 )
#define debugCP(s) do { } while( 0 )
#define debugInc(cnt) do { } while( 0 )
#define debugDec(cnt) do { } while( 0 )
#define debugIncNumb(cnt,numb) do { } while( 0 )
